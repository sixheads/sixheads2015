...
gulp.task('sass', function(){
    ...
    .pipe(gulp.dest('sixheads/wp-content/themes/sixheads/'))
...
gulp.task('images', function() {
  return gulp.src('dev/img/*')
    ...
    .pipe(gulp.dest('sixheads/wp-content/themes/sixheads/img/'))
...
gulp.task('watch', ['browserSync', 'sass'], function(){
    ...
    gulp.watch('sixheads/wp-content/themes/sixheads/**').on('change', browserSync.reload);
});
