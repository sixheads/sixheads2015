...
function sixheads_setup() {
	...
	add_image_size( 'tiny', 470 );
	add_image_size( 'small', 600 );
	add_image_size( 'x-large', 1200 );
	add_image_size( 'xx-large', 1600 );
	add_image_size( 'xxx-large', 1940 );
	add_image_size( 'project-thumb', 500, 537, true ); // true = cropped
	add_image_size( 'project-large', 1000, 1074, true ); // true = cropped

	// This theme uses wp_nav_menu() in one location.
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'sixheads' ),
		'secondary' => __( 'Secondary Menu', 'sixheads' ),
	) );
...
function sixheads_scripts() {
    ...
    wp_enqueue_script( 'sixheads-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );

	wp_enqueue_script( 'sixheads-main', get_template_directory_uri() . '/js/main.js', array('jquery'), '1.0', true );

	// wp_enqueue_script( 'sixheads-global', get_template_directory_uri() . '/js/global.js', array('jquery'), '1.0', true );
